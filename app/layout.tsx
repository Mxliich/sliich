...
export const metadata: Metadata = {
  title: "Sliich - A Modern Anonymous Messaging Platform",
  description: "Share anonymous messages, create polls, and connect with friends in a sleek, modern interface.",
    generator: 'v0.dev'
}
